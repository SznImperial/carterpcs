...
import { Send, Mail, Building2, User, MessageSquare, Check } from 'lucide-react';
...
const ContactSection = () => {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 md:py-24 relative overflow-hidden">
      <div className="orb w-[360px] h-[360px] bg-primary top-[-100px] right-[-140px] opacity-[0.1]" />
      ...
      <div className="relative z-10 max-w-4xl px-8">
        <div className={`mb-10 reveal ${visible ? 'visible' : ''}`}>
          ...
          <p className="text-slate-400 text-base mt-3 max-w-xl leading-relaxed">
            Brand partnerships and sponsorships are managed through{' '}
            <strong className="text-white font-semibold">Rakugo Media</strong>.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          <div className={`flex flex-col gap-4 reveal-left ${visible ? 'visible' : ''} delay-2`}>
            ...
            <div className="glass-card p-5">
              ...
              <div className="flex flex-col gap-1">
                {socials.map(({ Icon, label, handle, href, color, followers }) => (
                  ...
                  >
                    <div
                      className="p-2 rounded-lg flex-shrink-0 transition-transform duration-300 ease-out group-hover:scale-105"
          ...
          <div className={`reveal-right ${visible ? 'visible' : ''} delay-3`}>
            <div className="glass-card p-6">
              {submitted ? (
                <div className="flex flex-col items-center justify-center min-h-[380px] gap-5 text-center success-pop">
                  ...
                  <div>
                    <h3 className="font-display text-xl font-bold text-white mb-1.5 tracking-tight">
                      Message sent
                    </h3>
                    <p className="text-slate-400 text-sm">
                      Rakugo Media will respond within 48 hours.
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                >
                  <div className="grid grid-cols-2 gap-3.5">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="text"
                          className="input-field pl-9 text-sm py-3"
                          placeholder="John"
                          required
                        />
                      </div>
                  ...
                  <p className="text-[10px] text-slate-600 text-center">
                    Typically answered within 48 hours by Rakugo Media.
                  </p>
                </form>
              )}
            </div>
